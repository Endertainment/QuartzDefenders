...
public class SetPlayedGames extends SubCommand {
	...
	public void execute(CommandSender sender, String[] args) {
		if(!sender.hasPermission(PermissionsList.STATS_SET_PLAYED_GAMES)) {
	...
	public String getUsage() {
		return new ColorFormat("&8"+Symbols.RIGHT_QUOTE+" &b/stats setPlayedGames <games> [player] &8- &bSet amount of played games").format();
	}	
