...
public class RemovePoints extends SubCommand {

	@Override
	public void execute(CommandSender sender, String[] args) {
		if(!sender.hasPermission(PermissionsList.STATS_REMOVE_POINTS)) {
		...
		sp.addPoints(-points);
		sender.sendMessage(LoggerUtil.gameMessage("Stats", "&6" + points + "&7 points removed from player &6" + sp.getPlayer().getName()));
	...
	public String getUsage() {
		return new ColorFormat("&8"+Symbols.RIGHT_QUOTE+" &b/stats removePoints <points> [player] &8- &bAdd points").format();
	}
